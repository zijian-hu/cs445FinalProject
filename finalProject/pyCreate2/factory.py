...
class FactoryCreate:
    ...
    def create_tracker(self, tag_id, sd_x=0, sd_y=0, sd_theta=0, rate=0):
...
class FactorySimulation:
    ...
    def create_tracker(self, tag_id, sd_x=0.01, sd_y=0.01, sd_theta=0.01, rate=10):
        from .simulation import Tracker
        return Tracker(self._clientID, tag_id, self.create_time_helper(),
            sd_x=sd_x, sd_y=sd_y, sd_theta=sd_theta, rate=rate)
